        ...
        <div class="container py-xl-5 py-lg-3">
            <div class="row about-main py-3">
                <div class="col-lg-5 about-text-grid pr-xl-5">
                    ...
                    <hr>
                    <p class="mt-4">These are a most of them which are used by many people to create a blanket, sweaters or scalfs as well.</p>
                    <p class="mt-3">These are a most of them which are used by many people to create a blanket, sweaters or scalfs as well.</p>
